              ...
              <li>
                <div className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg">
                  <div className="flex items-start justify-between w-64 flex-col">
                    ...
                    <div className="flex items-start flex-col text-[#EDF4F4] mx-4 text-[18px] font-bold mt-10"></div>
                  </div>
                </div>
              </li>
            </ul>
            <ul className="absolute bottom-8 lg:bottom-6 space-y-2"></ul>
          </div>
        </div>
      </aside>
      {/* sidebar end */}
          ...
          <div className=" bg-black p-[24px]">
            <div className="bg-[#2C2C2C] flex items-start rounded-[16px] p-[24px]">
              ...
              <div className="text-white ml-2">
                {`Univesity courses' details : Please ask questions here`}
              </div>
            </div>
